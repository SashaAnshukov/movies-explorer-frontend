...
function Portfolio () {
    ...
    const text = {
        ...
        about: 'Я живу в Архангельске, закончил Архангельский государственный технический университет. У меня есть жена и сын. Люблю играть в футбол и орать под гитару.',
        link1: '',
